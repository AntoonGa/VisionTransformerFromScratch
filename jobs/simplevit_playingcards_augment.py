...
Features:
augment data using random transforms
transforms must be applied to new epoch
because of this preloading is not possible as it would return a statis transformed dataset
"""
import torch
...
if __name__ == "__main__":
    ...
    train_dataset = ImageDataset(
        ...
        transform=augmentation,  # random transforms
        preload=preload
    )
